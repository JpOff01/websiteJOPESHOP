...
function LandingPageCard1() {
  return (
    <div class="mt-40 flex justify-center gap-x-10">
        <section class="bg-BlackBackground inline-flex flex-col min-width-fit text-center p-10 rounded-xl gap-y-10 drop-shadow-md">
        ...
        <section class="bg-BlackBackground inline-flex flex-col min-width-fit text-center p-10 rounded-xl gap-y-10 drop-shadow-md">
            <h1 class="text-WhiteText font-title font-bold text-3xl uppercase">Mix</h1>
            <p class="text-WhiteText font-subtitle text-xl">Arquivo MP3, WAV <br/> e pistas separadas</p>
            <p class="text-WhiteText font-subtitle text-xl">Downloads ilimitados</p>
            <p class="text-WhiteText font-subtitle text-xl">500.000 streams <br/> de vídeo</p>
            <p class="text-WhiteText font-subtitle text-xl">500.000 streams <br/> de áudio</p>
            <h2 class="text-WhiteText font-title font-bold text-3xl mt-3">R$200,00</h2>
        </section>

        <section class="bg-BlackBackground inline-flex flex-col min-width-fit text-center p-10 rounded-xl gap-y-10 drop-shadow-md">
            <h1 class="text-WhiteText font-title font-bold text-3xl uppercase">Master</h1>
            <p class="text-WhiteText font-subtitle text-xl">Arquivo MP3, WAV <br/> e pistas separadas</p>
            <p class="text-WhiteText font-subtitle text-xl">Downloads ilimitados</p>
            <p class="text-WhiteText font-subtitle text-xl">Streams de vídeo <br/> ilimitados</p>
            <p class="text-WhiteText font-subtitle text-xl">Streams de áudio <br/> ilimitados</p>
            <h2 class="text-WhiteText font-title font-bold text-3xl mt-3">R$300,00</h2>
        </section>
    </div>
  )
}
